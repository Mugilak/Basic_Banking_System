...
<div class="container" style="background-color: lightgreen; font-size: 30px;">
        <h1 style="color: darkgreen;">Transfer Money</h1>
        <br>
            <table style="border: 4px solid black; font-size: 30px; border-collapse: collapse; width: 80%; margin-left: auto; margin-right: auto;">
                        ...
                        <thead>
                            ...
                            <th scope="col" style="text-align: center; height: 70px;">Operation</th>
                            </tr>
                        </thead>
                        <tbody>
                <?php 
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="selectuserdetail.php?id= <?php echo $rows['id'] ;?>"> <button id="submit" type="button" style="border-radius: 15px; background-color: darkgreen; color:white;">Transact</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
